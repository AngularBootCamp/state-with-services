# DRAFT - Angular Boot Camp Curriculum - state-with-services
...
[StackBlitz for state-with-services](https://stackblitz.io/github/AngularBootCamp/state-with-services)

Alternatively, you can clone the repository locally and run the
following commands:

```
git clone git@github.com:AngularBootCamp/state-with-services.git
cd state-with-services
yarn
yarn start
```
